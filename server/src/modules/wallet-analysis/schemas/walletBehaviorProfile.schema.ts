...
export const walletPersonaProfileSchema: z.ZodType<WalletPersonaProfile> = z
    .object({
        ...
        personaScores: z
            .object({
                UNKNOWN: score0to100Schema,
                LONG_TERM_HOLDER: score0to100Schema,
                CASUAL_USER: score0to100Schema,
                DEFI_TRADER: score0to100Schema,
                MEMECOIN_TRADER: score0to100Schema,
                NFT_COLLECTOR: score0to100Schema,
                AIRDROP_FARMER: score0to100Schema,
                BOT_LIKE_TRADER: score0to100Schema,
                HIGH_RISK_SPECULATOR: score0to100Schema,
                SMART_MONEY_LIKE: score0to100Schema,
                WASH_TRADING_SUSPECT: score0to100Schema,
            })
            .strict(),
