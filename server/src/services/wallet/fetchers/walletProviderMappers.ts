...
import { MoralisSwapResponseRoot, MoralisSwapResult, MoralisTradeLeg } from "./walletThirdPartyResponses";
...
export function mapMoralisSwapEntry(entry: MoralisSwapResult, address: string): WalletSwap | null {
    ...
    const blockTimestampIso = toIsoTimestamp(
    ...
    return {
        ...
        exchangeAddress: entry.exchangeAddress,
        exchangeName: entry.exchangeName,
        exchangeLogo: entry.exchangeLogo,
        bought,
        sold,
