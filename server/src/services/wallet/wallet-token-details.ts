...
export async function getTokenDetails(wallet: string) {
  ...
  const tokenDetails = res.data.tokens.map(
    (tokenDetail): WalletTokenDetailsInsert => ({
      ...
      totalBuy: tokenDetail.counts.total_buy,
      totalSell: tokenDetail.counts.total_sell,
      totalTrade: tokenDetail.counts.total_trade,
      totalBoughtAmount: tokenDetail.quantity.total_bought_amount,
      totalSoldAmount: tokenDetail.quantity.total_sold_amount,
      holding: tokenDetail.quantity.holding,
      costOfQuantitySold: tokenDetail.cashflow_usd.cost_of_quantity_sold,
      totalInvested: tokenDetail.cashflow_usd.total_invested,
      totalSold: tokenDetail.cashflow_usd.total_sold,
      ...
      unrealizedUsd: tokenDetail.pnl.unrealized_usd,
      unrealizedPercent: tokenDetail.pnl.unrealized_percent,
      totalUsd: tokenDetail.pnl.total_usd,
      totalPercent: tokenDetail.pnl.total_percent,
      avgProfitPerTradeUsd: tokenDetail.pnl.avg_profit_per_trade_usd,
      currentPrice: tokenDetail.pricing.current_price,
