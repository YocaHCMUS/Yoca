  ...
  .delete(
    ...
    async (c) => {
      try {
        ...
        if (
          err instanceof Error &&
          err.message === "ACCOUNT_DELETE_FORBIDDEN"
        ) {
          return c.json(setErr("ACCOUNT_DELETE_FORBIDDEN"), 403);
        }
      ...
      try {
        ...
        try {
          ...
          if (
            ...
            return c.json({ error: "Wallet already linked to user" }, 409);
          }
      ...
      try {
        ...
        try {
          ...
          if (
            ...
            return c.json({ error: "Wallet link does not exist" }, 404);
          }
