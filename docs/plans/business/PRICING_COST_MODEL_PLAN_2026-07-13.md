...
- [ ] Verify 6+ endpoint Birdeye đang dùng (mục 2.2: holders, pools, pool-trades, trending, top, gainers, new-pairs) có nằm trong giới hạn "3 endpoint" của free tier hay không — quyết định có cần nâng Lite ngay hay chỉ cần sửa lại đúng 1 req/s là đủ.
