...
\begin{xltabular}{\textwidth}{|>{\centering\arraybackslash}p{1.4cm}|>{\centering\arraybackslash}p{2.5cm}|X|>{\RaggedRight\arraybackslash}p{3.5cm}|}
    ...
    & & Cấu hình đa ngôn ngữ (Internationalization). & D.H.H Phúc, L.M Quân \\ \cline{3-4}
    ...
    % SPRINT 12
    \textbf{12} & 30/03/2026 \newline - \newline 12/04/2026 
    & Lấy dữ liệu lịch sử giao dịch để dựng Prototype theo dõi dòng tiền (Holder Bubble / Transaction Trace). & D.H.H Phúc, V.H.A Quân \\ \cline{3-4}
    & & Cài đặt UI cho tính năng So sánh ví dựa trên Prototype đã thiết kế. & L.V.M Phương, N.M Phương \\ \cline{3-4}
