...
Hình~\ref{fig:db_alert_history} tách định nghĩa cảnh báo khỏi trạng thái, delivery target và điều kiện kích hoạt. \texttt{alert\_history} là phần lược đồ dự kiến lưu sự kiện đã phát sinh, phục vụ màn hình lịch sử và trạng thái đã đọc. Tại thời điểm hoàn thiện báo cáo, luồng ghi sau delivery và API đọc/đánh dấu đã đọc vẫn là hạng mục triển khai bắt buộc.
