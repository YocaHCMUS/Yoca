...
% TODO(runtime): Hoàn thiện ghi alert_history sau khi gửi cảnh báo thành công.
% TODO(runtime): Bổ sung API xem lịch sử, đánh dấu đã đọc và cơ chế chống gửi trùng.
