...
Yêu cầu thứ tư là bảo vệ dữ liệu và thao tác cá nhân. Phiên đăng nhập, watchlist, nhãn ví, cảnh báo, lịch sử thanh toán và chức năng AI theo gói phải được kiểm tra quyền truy cập ở phía server. API key, secret xác thực và thông tin thanh toán không được đưa vào bundle phía client. Những thao tác nhạy cảm như liên kết ví hoặc xóa tài khoản cần có bước chứng minh quyền sở hữu hoặc xác nhận bổ sung.
