...
\textbf{Tổng lượng volume bất thường.} Với $q_v$ là tổng lượng token đi qua ví và $q_{max}$ là giá trị lớn nhất trong tập đang phân tích, đặc trưng khối lượng là
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        ...
        tổng lượng volume bất thường & 0,06 & 0,05 & 0,10 \\
        \hline
