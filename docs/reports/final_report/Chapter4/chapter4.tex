...
Job \texttt{deploy} thành công có nghĩa hai lệnh gọi deploy hook đã được gửi và Render đã nhận yêu cầu; đây là bằng chứng cho bước liên kết CI--Render đã chạy thật trên \texttt{main}, không chỉ là kiến trúc dự kiến. Báo cáo chưa đính kèm ảnh chụp trực tiếp trạng thái build hoàn tất trên Render dashboard cho cả hai service; nhóm xem đây là phần bằng chứng còn thiếu và sẽ bổ sung nếu chụp được trước khi nộp.
