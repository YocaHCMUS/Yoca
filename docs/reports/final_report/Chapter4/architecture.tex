...
\hline
Vượt giới hạn AI theo gói (429) & \texttt{\{ usage, limit, resetAt \}} từ \texttt{WalletAiDailyLimitError}, giúp client hiển thị đúng trạng thái thay vì lỗi chung \\
\hline
\end{tabularx}
\end{table}
