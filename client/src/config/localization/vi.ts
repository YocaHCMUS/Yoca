...
export const translation = defineTranslation({
  ...
  walletPage: {
    ui: {
      ...
      editLabel: "Chỉnh sửa nhãn ví",
      actions: "Thao tác với ví",
      period: "Khoảng thời gian phân tích",
      dismiss: "Đóng thông báo",
      refresh: "Làm mới dữ liệu",
      periodChange: "Khoảng thời gian",
      recentOnchainActivity: "Các giao dịch swap và chuyển token gần đây trên blockchain",
      totalPortfolio: "Giá trị danh mục",
      assetsHeld: "Đang nắm giữ {{count}} tài sản",
      addTokenAddress: "Dán địa chỉ token",
      add: "Thêm",
      tokenWatchlist: "Theo dõi token",
      walletWatchlist: "Theo dõi ví",
      noTokensWatched: "Chưa có token nào trong danh sách theo dõi.",
      noWalletsWatched: "Chưa có ví nào trong danh sách theo dõi.",
      labels: "Nhãn ví",
      noLabels: "Chưa tạo nhãn ví nào.",
      todayVolume: "Khối lượng 24 giờ",
      removeToken: "Bỏ token",
      removeWallet: "Bỏ ví",
      assignLabel: "Đặt nhãn tùy chỉnh",
      customLabel: "Nhãn tùy chỉnh",
      walletAddress: "Địa chỉ ví",
      labelPlaceholder: "Ví dụ: Ví giao dịch của tôi",
      cancel: "Hủy",
      save: "Lưu",
      manageWalletTags: "Quản lý nhãn ví",
      tags: "Nhãn",
      tagPlaceholder: "Ví dụ: Cá voi, Smart Money",
      removeTag: "Xóa nhãn {{tag}}",
      newTag: "Nhãn mới",
      addTagHint: "Nhấn Enter hoặc nhập dấu phẩy để thêm nhãn.",
      forensicAudit: "Kiểm toán rủi ro",
    },
