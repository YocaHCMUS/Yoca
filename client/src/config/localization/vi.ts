...
export const translation = defineTranslation({
  ...
  token: {
    ...
    marketsDescription: 'Các sàn giao dịch phi tập trung hàng đầu giao dịch {{name}}.',
    ...
    historicalData: {
      ...
      close: 'Giá đóng cửa',
      showMore: 'Xem thêm',
      error: 'Không thể tải dữ liệu lịch sử. Token này có thể chưa được niêm yết trên CoinGecko.',
    },
    insightTabs: {
      about: 'Thống kê',
      holders: 'Người nắm giữ',
      ...
      distributionDescription: 'Phân bổ quyền sở hữu token {{symbol}} theo nhóm người nắm giữ hàng đầu.',
      top10: 'Top 10',
      rank1120: '11–20',
      rank2140: '21–40',
      rank1130: '11–30',
      rank3150: '31–50',
      others: 'Khác',
      volumeQ: 'Khối lượng giao dịch hàng ngày của {{name}} ({{symbol}}) là bao nhiêu?',
      volumeA: 'Khối lượng giao dịch 24h của {{name}} ({{symbol}}) là {{volume}}, biến động {{change}} so với ngày hôm trước.',
      athAtlQ: 'Giá cao nhất và thấp nhất mọi thời đại của {{name}} ({{symbol}}) là bao nhiêu?',
      athAtlA: '{{name}} ({{symbol}}) đạt đỉnh cao mọi thời đại là {{ath}} và đáy thấp nhất là {{atl}}. Hiện đang giao dịch {{athPct}} so với đỉnh và {{atlPct}} trên mức thấp nhất đã ghi nhận.',
      marketCapQ: 'Vốn hóa thị trường của {{name}} ({{symbol}}) là bao nhiêu?',
      marketCapA: 'Vốn hóa thị trường của {{name}} ({{symbol}}) là {{marketCap}}, xếp hạng #{{rank}} theo vốn hóa hôm nay. Vốn hóa được tính bằng giá token nhân với nguồn cung lưu hành — {{supply}} token đang lưu thông trên thị trường.',
