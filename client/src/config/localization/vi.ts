...
export const translation = defineTranslation({
  ...
  walletPage: {
    ...
    tokenWinRate: {
      ...
      summaryShort: "{{win}} token sinh lời / {{tradedCount}} token đã giao dịch",
      avgWin: "Lãi TB",
      avgLoss: "Lỗ TB",
      explanationAria: "Giải thích tỷ lệ thắng token",
      tooltipWinRateLabel: "Tỷ lệ thắng token",
      tooltipWinRateDescription: "là tỷ lệ token sinh lời trên tổng số token đã giao dịch trong khoảng {{period}}. Token sinh lời được xác định khi PnL đã chốt lớn hơn 0.",
      tooltipAverageLabel: "Lãi TB / Lỗ TB",
      tooltipAverageDescription: "là lợi nhuận hoặc thua lỗ đã chốt trung bình trên mỗi token đã giao dịch.",
    },
    aiSwapSummary: {
  ...
  washTrading: {
    ...
    errors: {
      missingMint: "Thiếu địa chỉ token mint. Hãy mở trang từ Token Detail hoặc nhập mint để phân tích.",
    ...
    verdict: {
      ...
      defaultSummary: "Nhấn Chạy phân tích AI để phân tích giao dịch vòng lặp, độ tương đồng khối lượng, nhịp giao dịch và đặc trưng graph của token này.",
    ...
    graph: {
      ...
      footerReady: "Graph force-directed lấy từ backend graphData. Kéo node, zoom, pan và hover cạnh/ví để xem chi tiết luồng giao dịch.",
      footerWaiting: "Đang chờ backend graphData. Nhấn Chạy phân tích AI để tạo graph giao dịch ví.",
      fullscreen: "Toàn màn hình",
    ...
    wallets: {
      ...
      insightEmpty: "Chọn một ví trong danh sách Ví đáng ngờ để xem giải thích AI chi tiết.",
      selectedWallet: "Ví đã chọn",
      explanation: "AI đánh dấu ví này vì pattern {{pattern}} trên token {{symbol}}. Điểm GNN hiện tại là {{score}}/100.",
