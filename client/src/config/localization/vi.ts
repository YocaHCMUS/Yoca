...
export const translation = defineTranslation({
  ...
  chat: {
    ...
    greetingDescription: "Tôi có thể giúp bạn phân tích danh mục đầu tư, hiệu suất và hoạt động giao dịch của ví này.",
    greetingDescriptionComparison: "Tôi có thể giúp bạn phân tích danh mục đầu tư, hiệu suất và hoạt động giao dịch của các ví này.",
