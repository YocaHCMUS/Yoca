...
export const translation = defineTranslation({
  ...
  chat: {
    ...
    prompt: {
      ...
      trades: { label: "Giao dịch gần đây", query: "Hiển thị các giao dịch swap gần đây với chi tiết token và giá trị USD." },
      risk: { label: "Phân tích rủi ro", query: "Phân tích mức độ rủi ro của ví này. Các yếu tố rủi ro và điểm tin cậy là gì?" },
      tokens: { label: "Token hàng đầu", query: "Các token tôi đang nắm giữ theo giá trị USD là gì?" },
      balance: { label: "Xu hướng số dư", query: "Hiển thị biểu đồ lịch sử số dư của tôi trong 30 ngày qua." },
      volume: { label: "Xu hướng khối lượng", query: "Xu hướng khối lượng giao dịch hàng ngày của tôi trong 30 ngày qua là gì?" },
      audit: { label: "Kiểm toán pháp y", query: "Thực hiện kiểm toán pháp y trên ví này. Bạn thấy đặc điểm và mẫu hành vi nào?" },
    },
  },
  ERROR: {
