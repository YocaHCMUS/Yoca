...
export const translation = defineTranslation({
  ...
  walletPage: {
    ...
    aiSummary: "Tóm tắt",
    aiClassification: "Phân loại",
    aiPrimaryType: "Loại chính",
    aiConfidence: "Độ tin cậy",
    aiSupportingSignals: "Tín hiệu hỗ trợ",
    aiStrategy: "Chiến lược",
    aiPrimaryStrategy: "Chiến lược chính",
    aiSecondaryStrategies: "Chiến lược phụ",
    aiEvidence: "Bằng chứng",
    aiBehaviorMetrics: "Chỉ số hành vi",
    aiTradeFrequency: "Tần suất giao dịch",
    aiAvgHoldingTime: "Thời gian nắm giữ trung bình",
    aiPortfolioConcentration: "Mức tập trung danh mục",
    aiWinLossEstimate: "Ước tính thắng/thua",
    aiTokenDistribution: "Phân bổ token",
    aiFirstFunderAnalysis: "Phân tích ví tài trợ đầu",
    aiFunderType: "Loại nguồn tài trợ",
    aiRiskSignal: "Tín hiệu rủi ro",
    aiNotes: "Ghi chú",
    aiWalletAge: "Tuổi ví",
    aiAgeCategory: "Phân loại tuổi",
    aiFirstSeen: "Lần xuất hiện đầu",
    aiConsistencyAssessment: "Đánh giá độ nhất quán",
    aiRiskAssessment: "Đánh giá rủi ro",
    aiOverallRisk: "Rủi ro tổng thể",
    aiFlags: "Cờ cảnh báo",
  },
  dictionary: {
    tradingStrategy: {
