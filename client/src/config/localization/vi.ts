...
export const translation = defineTranslation({
  ...
  profileTabs: {
    activity: {
      ...
      tableHeaders: {
        swaps: ["Ví", "Thời gian", "Cặp", "Sàn giao dịch", "Giá trị tổng"],
        transfers: ["Token", "Số lượng", "Giá trị (USD)", "Thời gian"],
      },
    ...
    alerts: {
      ...
      tableHeaders: ["Token", "Loại", "Điều kiện", "Trạng thái", "Cập nhật", "Hành động"],
    ...
    dashboard: {
      ...
      concentrationHeaders: ["Ví", "Giá trị", "Chia sẻ"],
    ...
    wallet: {
      ...
      tableHeaders: ["Ví", "Giá trị ròng", "PnL", "Giao dịch"],
