...
export const translation = defineTranslation({
  ...
  marketPage: {
    ...
    topGainers: "Top các ví lời nhất",
    topGainersDesc: "Danh sách các ví có lợi nhuận cao nhất.",
    topLosers: "Top các ví lỗ nhất",
    topLosersDesc: "Danh sách các ví có lợi nhuận thấp nhất (lỗ nhiều nhất).",
    recentTrades: "Giao dịch gần đây",
    recentTradesDesc: "Các giao dịch hoán đổi token gần nhất trên các sàn giao dịch.",
    ...
    allTokensSubtitle: "Thị trường tiền điện tử toàn cầu đang tiếp tục phát triển với nhiều hoạt động đáng chú ý. Dưới đây là tổng quan về các token hàng đầu theo vốn hóa thị trường và hiệu suất gần đây của chúng.",
    watchlistTitle: "Danh sách theo dõi của bạn",
    watchlistSubtitle: "Theo dõi các token yêu thích của bạn và giám sát hiệu suất của chúng ở một nơi duy nhất.",
    tradesTitle: "Hoạt động thị trường & Điểm nổi bật",
    tradesSubtitle: "Khám phá các nhà giao dịch có lợi nhuận cao nhất và các giao dịch hoán đổi mới nhất trên các sàn giao dịch phi tập trung.",
    filterAll: "Tất cả",
