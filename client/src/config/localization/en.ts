...
export const translation = {
  ...
  walletPage: {
    ...
    tokenWinRate: {
      ...
      tooltipWinRateDescription: "is the ratio of profitable tokens to total traded tokens during {{period}}. A token is counted as profitable when realized PnL is greater than 0.",
  ...
  washTrading: {
    ...
    errors: {
      missingMint: "Missing token mint address. Open this page from Token Detail or enter a mint address to analyze.",
    ...
    verdict: {
      ...
      defaultSummary: "Click Run AI Analyze to analyze circular trading, amount similarity, timing regularity, and graph features for this token.",
    ...
    graph: {
      ...
      footerReady: "Live force-directed graph from backend graphData. Drag nodes, zoom, pan, and hover edges/wallets to inspect flow details.",
      footerWaiting: "Waiting for backend graphData. Click AI Analyze to build the wallet transaction graph.",
      fullscreen: "Fullscreen",
      ...
      modalSubtitle: "{{symbol}} · {{mint}} · {{nodes}} nodes · {{edges}} edges",
      close: "Close",
    ...
    wallets: {
      ...
      insightEmpty: "Select a wallet from Suspicious Wallets to view the detailed AI explanation.",
      selectedWallet: "Selected wallet",
      explanation: "AI flagged this wallet because of pattern {{pattern}} on token {{symbol}}. Current GNN score is {{score}}/100.",
