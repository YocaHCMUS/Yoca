...
export const translation = {
  ...
  walletPage: {
    ...
    aiPrimaryType: "Primary type",
    aiConfidence: "Confidence",
    aiSupportingSignals: "Supporting signals",
    aiStrategy: "Strategy",
    aiPrimaryStrategy: "Primary strategy",
    aiSecondaryStrategies: "Secondary strategies",
    aiEvidence: "Evidence",
    aiBehaviorMetrics: "Behavior metrics",
    aiTradeFrequency: "Trade frequency",
    aiAvgHoldingTime: "Average holding time",
    aiPortfolioConcentration: "Portfolio concentration",
    aiWinLossEstimate: "Win/Loss estimate",
    aiTokenDistribution: "Token distribution",
    aiFirstFunderAnalysis: "First funder analysis",
    aiFunderType: "Funder type",
    aiRiskSignal: "Risk signal",
    aiNotes: "Notes",
