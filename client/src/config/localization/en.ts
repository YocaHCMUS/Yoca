...
export const translation = {
  ...
  marketPage: {
    ...
    allTokensSubtitle: "The global cryptocurrency market continues to evolve with significant activity across key assets. Below is an overview of the top tokens by market capitalization and their recent performance.",
    watchlistTitle: "Your Watchlist",
    watchlistSubtitle: "Track your favorite tokens and monitor their performance in one place.",
    tradesTitle: "Market Activity & Highlights",
    tradesSubtitle: "Discover top performing traders and the latest significant swaps across decentralized exchanges.",
    filterAll: "All",
