...
export const translation = {
  ...
  walletPage: {
    ui: {
      ...
      editLabel: "Edit wallet label",
      actions: "Wallet actions",
      period: "Analysis period",
      dismiss: "Dismiss",
      refresh: "Refresh data",
      periodChange: "Time period",
      recentOnchainActivity: "Recent swaps and transfers observed on-chain",
      totalPortfolio: "Portfolio value",
      assetsHeld: "{{count}} assets held",
      addTokenAddress: "Paste token address",
      add: "Add",
      tokenWatchlist: "Token watchlist",
      walletWatchlist: "Wallet watchlist",
      noTokensWatched: "No tokens in your watchlist yet.",
      noWalletsWatched: "No wallets in your watchlist yet.",
      labels: "Wallet labels",
      noLabels: "No wallet labels created.",
      todayVolume: "24h volume",
      removeToken: "Remove token",
      removeWallet: "Remove wallet",
      assignLabel: "Assign custom label",
      customLabel: "Custom label",
      walletAddress: "Wallet address",
      labelPlaceholder: "e.g. My trading wallet",
      cancel: "Cancel",
      save: "Save",
      manageWalletTags: "Manage wallet tags",
      tags: "Tags",
      tagPlaceholder: "e.g. Whale, Smart Money",
      removeTag: "Remove tag {{tag}}",
      newTag: "New tag",
      addTagHint: "Press Enter or type a comma to add a tag.",
