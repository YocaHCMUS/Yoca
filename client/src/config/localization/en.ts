...
export const translation = {
  ...
  token: {
    ...
    historicalData: {
      ...
      close: 'Close',
      showMore: 'Show More',
      error: 'Failed to fetch historical data. This token may not be listed on CoinGecko.',
    },
    insightTabs: {
      about: 'Stats',
      holders: 'Holders',
      ...
      distributionDescription: 'Breakdown of {{symbol}} token ownership among top holders.',
      top10: 'Top 10',
      rank1120: '11–20',
      rank2140: '21–40',
      rank1130: '11–30',
      ...
      volumeA: 'The 24h trading volume of {{name}} ({{symbol}}) is {{volume}}, representing a {{change}} change versus the previous day.',
      athAtlQ: 'What is the highest and lowest price for {{name}} ({{symbol}})?',
      athAtlA: '{{name}} ({{symbol}}) reached an all-time high of {{ath}} and an all-time low of {{atl}}. It is currently trading {{athPct}} from its peak and {{atlPct}} above its lowest recorded price.',
      marketCapQ: 'What is the market cap of {{name}} ({{symbol}})?',
      marketCapA: 'Market capitalization of {{name}} ({{symbol}}) is {{marketCap}}, ranked #{{rank}} by market cap today. Market cap is measured by multiplying the token price with the circulating supply — {{supply}} tokens are tradable on the market today.',
