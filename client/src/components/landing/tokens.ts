...
const landingThemeStyles: Record<ThemeMode, CSSVariableStyle> = {
  dark: {
    ...
    "--landing-grid-purple": "rgba(153, 69, 255, 0.05)",
    "--landing-grid-green": "rgba(20, 241, 149, 0.05)",
  ...
  light: {
    "--landing-bg": "#f3f7f6",
    "--landing-surface": "rgba(250,253,252,0.78)",
    "--landing-surface-strong": "rgba(250,253,252,0.92)",
    "--landing-foreground": "#0f172a",
    "--landing-muted": "#566474",
    "--landing-border": "rgba(15,23,42,0.08)",
    "--landing-grid-purple": "rgba(153, 69, 255, 0.025)",
    "--landing-grid-green": "rgba(20, 241, 149, 0.03)",
    "--landing-card-bg": "rgba(250,253,252,0.86)",
    "--landing-card-border": "rgba(15,23,42,0.07)",
    "--landing-card-shadow": "0 18px 44px -34px rgba(15,23,42,0.24)",
    "--landing-button-secondary-bg": "rgba(20,241,149,0.075)",
    "--landing-button-secondary-hover-bg": "rgba(20,241,149,0.13)",
    "--landing-button-secondary-border": "rgba(153,69,255,0.22)",
    "--landing-button-secondary-hover-border": "rgba(20,241,149,0.42)",
    "--landing-section-border": "rgba(15,23,42,0.06)",
    "--landing-panel-bg": "rgba(250,253,252,0.88)",
    "--landing-accent": LANDING_ACCENT,
  },
};
