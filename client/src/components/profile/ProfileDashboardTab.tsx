...
export function ProfileDashboardTab({ data }: ProfileDashboardTabProps) {
  ...
  const conentrationHeaders = [
    tr("profileTabs.dashboard.concentrationHeaders.wallet"),
    tr("profileTabs.dashboard.concentrationHeaders.value"),
    tr("profileTabs.dashboard.concentrationHeaders.share"),
  ];
