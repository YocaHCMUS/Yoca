    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          return formatItemTooltip(wallet.walletAddress, [
            // { label: 'Address', value: wallet.walletAddress },
            { label: "Rank", value: `#${wallet.rank}` },
            {
              label: "Total Volume",
              value: formatCurrency(wallet.totalVolume),
            },
            {
              label: "Deposits",
              value: formatCurrency(wallet.depositVolume),
              labelColor: chartTheme.colorPalette[1],
            },
            {
              label: "Withdrawals",
              value: formatCurrency(wallet.withdrawalVolume),
              labelColor: chartTheme.colorPalette[2],
            },
