      ...
      >
        ...
        <div className={`${styles.formBox} ${isLight ? styles.light : ""} ${styles.login}`}>
          <form onSubmit={handleLoginSubmit(onLogin)}>
            ...
            <div className={styles.inputBox}>
              <input type="email" placeholder={tr("auth.email")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerLogin("email")} />
            ...
            <div className={styles.inputBox}>
              <input type="password" placeholder={tr("auth.password")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerLogin("password")} />
        ...
        <div className={`${styles.formBox} ${isLight ? styles.light : ""} ${styles.register}`}>
          <form onSubmit={handleRegisterSubmit(onSignup)}>
            ...
            <div className={styles.inputBox}>
              <input type="email" placeholder={tr("auth.email")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerSignup("email")} />
              <i className={`bx bxs-envelope ${isLight ? styles.light : ""}`}></i>
            </div>
            {registerErrors.email && <span className={`${styles.errorText} ${isLight ? styles.light : ""}`}>{registerErrors.email.message}</span>}

            <div className={styles.inputBox}>
              <input type="text" placeholder={tr("auth.displayName")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerSignup("displayName")} />
            ...
            <div className={styles.inputBox}>
              <input type="password" placeholder={tr("auth.password")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerSignup("password")} />
              <i className={`bx bxs-lock-alt ${isLight ? styles.light : ""}`}></i>
            </div>
            {registerErrors.password && <span className={`${styles.errorText} ${isLight ? styles.light : ""}`}>{registerErrors.password.message}</span>}

            <div className={styles.inputBox}>
              <input type="password" placeholder={tr("auth.confirmPassword")} disabled={isSubmitting} className={isLight ? styles.light : ""} {...registerSignup("retypePassword")} />
              <i className={`bx bxs-lock-alt ${isLight ? styles.light : ""}`}></i>
            </div>
